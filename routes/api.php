    ...
    Route::prefix('auth')->group(function () {
        ...
        Route::middleware('auth:distributor')->group(function () {
            Route::controller(AuthDistribController::class)->group(function () {
                ...
                Route::post('/distributor/profile/update-info', 'updateProfileInfo');
                Route::post('/distributor/profile/update-password', 'updateProfilePassword');
    ...
    */
    ...
    Route::middleware([
        ...
        Route::controller(NotificationController::class)->group(function () {
            Route::get('/getNotificationData', 'getAdminNotifications');
        });
        ...
        Route::controller(ProductsController::class)->group(function () {
            ...
            Route::get('/transfersGetMobile', 'transfersGetMobile');
        });
        ...
        Route::controller(DetteCylindreController::class)->group(function () {
            ...
            Route::get('/rapprotDetteCylindre','rapprotDetteCylindre');
        });
    });
});
